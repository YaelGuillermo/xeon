...
{
    public partial class AlbumGenero : Form, IVAlbumGenre
    {
        //Fields
        ...
        public string IDAlbumGenero
        {
            get { return txtIDAlbumGenero.Text; }
            set { txtIDAlbumGenero.Text = value; }
        }
        ...
        public void SetArtistGenreListBindingSource(BindingSource AlbumGeneroList)
        {
            dataGridView.DataSource = AlbumGeneroList;
        }

        // Single pattern
        private static AlbumGenero instance;
        public static AlbumGenero GetInstance(Form parentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new AlbumGenero();
        ...
        private void AlbumGenero_Load(object sender, EventArgs e)
        {
