...
{
    public partial class AlbumArtista : Form, IVAlbumArtist
    {
        //Fields
        ...
        public string IDAlbumArtista
        {
            get { return txtIDAlbumArtista.Text; }
            set { txtIDAlbumArtista.Text = value; }
        }
        ...
        public void SetArtistGenreListBindingSource(BindingSource AlbumArtistaList)
        {
            dataGridView.DataSource = AlbumArtistaList;
        }

        // Single pattern
        private static AlbumArtista instance;
        public static AlbumArtista GetInstance(Form parentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new AlbumArtista();
        ...
        private void AlbumArtista_Load(object sender, EventArgs e)
        {
